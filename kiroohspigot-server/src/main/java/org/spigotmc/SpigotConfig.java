...
public class SpigotConfig
{
    ...
    public static String outdatedClientMessage = "Outdated client detected, please join using 1.7.10 - 1.8.8";
    public static String outdatedServerMessage = "Only 1.7 and 1.8 players can join, please join using 1.7.10 - 1.8.8";
    ...
    private static void messages()
    {
        ...
        serverFullMessage = transform( getString( "messages.server-full", "The server is full! Purchase rank to bypass." ) );
