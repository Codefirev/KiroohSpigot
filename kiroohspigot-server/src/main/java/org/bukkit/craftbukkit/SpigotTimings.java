...
public class SpigotTimings {
    ...
    public static final CustomTimingsHandler updatePosition = new CustomTimingsHandler("** updatePosition");
    public static final CustomTimingsHandler updateRotation = new CustomTimingsHandler("** updateRotation");
