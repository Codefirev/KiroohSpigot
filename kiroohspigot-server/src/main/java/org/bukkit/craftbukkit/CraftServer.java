...
public final class CraftServer implements Server {
    ...
    private final String serverName = "hSpigot";
    private String serverGroup = "Dev"; // hSpigot
    ...
    public void setMaxPlayers(int amount) {
        playerList.setMaxPlayers(amount);
    }
    ...
    private void loadPlugin(Plugin plugin) {
        ...
        // GOMID start - plugin types
        if(plugin.getName().equals("UHC")) {
            SLSpigotConfig.uhc = true;
        } else if(plugin.getName().equals("Inferno")) {
            SLSpigotConfig.practice = true;
        }
        // GOMID end
    }
    ...
    public String getServerName() {
        return this.getConfigString("server-name", "hSpigot");
    }
    ...
    public void reload() {
        ...
        SLSpigotConfig.init();
        SLSpigotConfig.registerCommands();
    ...
    private void loadCustomPermissions() {
        File file = new File("config/server", configuration.getString("settings.permissions-file"));
    ...
    public Set<OfflinePlayer> getOperators() {
        ...
        for (GameProfile entry : playerList.getOPs()) {
            result.add(getOfflinePlayer(entry));
        }
