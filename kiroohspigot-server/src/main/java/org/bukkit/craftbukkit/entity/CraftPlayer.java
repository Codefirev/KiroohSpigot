...
public class CraftPlayer extends CraftHumanEntity implements Player {
    ...
    public long getLastTeleported() {
        return this.lastTeleported;
    }

    @Override
    public void setLastTeleported(long value) {
        this.lastTeleported = value;
    }
    ...
    public String getDisplayName() {
        return getHandle().displayName; // MineHQ - Disguises
    }
    ...
    public void setPlayerListName(String name) {
        ...
        if (!SLSpigotConfig.playerListPackets) return; // MineHQ
    ...
    public boolean teleport(Location location, PlayerTeleportEvent.TeleportCause cause) {
        ...
        // GOMID start - last teleport for Paik
        this.lastTeleported = System.currentTimeMillis();
        // GOMID end
    ...
    public int getVersion() {
        return this.getHandle().playerConnection.networkManager.getVersion();
    }

    @Override
    public boolean isLunarClient() {
        return this.lunarClient;
    }

    @Override
    public void sendPacket(Object object) {
        if(object instanceof Packet) {
            this.getHandle().playerConnection.sendPacket((Packet) object);
        }
    }
