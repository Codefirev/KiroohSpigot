...
public class CraftChunk implements Chunk {
    ...
    @Override
    public network.secondlife.spigot.chunksnapshot.ChunkSnapshot takeSnapshot() {
        net.minecraft.server.Chunk handle = getHandle();
        network.secondlife.spigot.chunksnapshot.CraftChunkSnapshot snap = new network.secondlife.spigot.chunksnapshot.CraftChunkSnapshot();
    ...
    @Override
    public void restoreSnapshot(network.secondlife.spigot.chunksnapshot.ChunkSnapshot snapshot) {
        network.secondlife.spigot.chunksnapshot.CraftChunkSnapshot snap = (network.secondlife.spigot.chunksnapshot.CraftChunkSnapshot) snapshot;
        net.minecraft.server.Chunk handle = getHandle();
