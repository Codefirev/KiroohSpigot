...
public class NameReferencingFileConverter {
    ...
    public static final File a = new File("config/banned-ips.txt");
    public static final File b = new File("config/banned-players.txt");
    public static final File c = new File("config/ops.txt");
    public static final File d = new File("config/white-list.txt");
