...
import network.secondlife.spigot.util.IndexedLinkedHashSet;
...
public class EntityTracker {
    ...
    public void addEntity(Entity entity, int i, int j, boolean flag) {
        ...
        try {
            ...
            EntityTrackerEntry entitytrackerentry = new EntityTrackerEntry(this, entity, i, j, flag); // GOMID

            this.c.add(entitytrackerentry);
            this.trackedEntities.a(entity.getId(), entitytrackerentry);
            // entitytrackerentry.scanPlayers(this.world.players); // GOMID
