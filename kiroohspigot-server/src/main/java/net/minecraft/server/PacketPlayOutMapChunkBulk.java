...
import network.secondlife.spigot.ReusableByteArray;
...
public class PacketPlayOutMapChunkBulk extends Packet {
    ...
    public int[] d;
    public byte[] buffer;
    public static final ReusableByteArray bufferCache = new ReusableByteArray(820480); // MineHQ
    public byte[][] inflatedBuffers;
    public int size;
    public boolean h;
    public byte[] buildBuffer; // MineHQ
    public static final ReusableByteArray buildBufferCache = new ReusableByteArray(820480); // MineHQ
    // CraftBukkit start
