...
import network.secondlife.spigot.timings.ExtendedCustomTimingsHandler;
...
import network.secondlife.spigot.autosave.AutoSave;
// Poweruser end
...
public abstract class MinecraftServer implements ICommandListener, Runnable, IMojangStatistics {
    ...
    public String getServerModName() {
        return "PaperSpigot"; // MineHQ - ayy lmao
    }
