...
public abstract class EntityLiving extends Entity {
    ...
    public void setHealth(float f) {
        ...
        if (this instanceof EntityPlayer) {
            ...
            if (player.getHealth() != 0 || !SLSpigotConfig.instantRespawn) {
    ...
    public boolean damageEntity(DamageSource damagesource, float f) {
        ...
        if (this.isInvulnerable()) {
            ...
            if (this.getHealth() <= 0.0F) {
                ...
                int maxNoDamageTicks = (this instanceof EntityHuman ? ((EntityHuman) this).getKnockback().hitDelay.value : this.maxNoDamageTicks);

                if (this.noDamageTicks > maxNoDamageTicks / 2) {
                    //return false;
    ...
    public void a(DamageSource damageSource, float damage, double xo, double zo) {
    ...
    protected void bo() {
        ...
        if (SLSpigotConfig.disableEntityCollisions || !ActivationRange.checkIfActive(this)) { // MineHQ
            return;
        }
