...
public abstract class EntityHuman extends EntityLiving implements ICommandListener {
    ...
    public KnockbackProfile getKnockback() {
        return this.knockback == null ? KnockbackModule.getDefault() : this.knockback;
    }
    ...
    public void attack(Entity entity) {
        if (entity.av() && !entity.j(this)) {
            ...
            if (f > 0.0F || f1 > 0.0F) {
                boolean flag = !this.world.paperSpigotConfig.disablePlayerCrits && this.fallDistance > 0.0f && !this.onGround && !this.h_() && !this.M() && !this.hasEffect(MobEffectList.BLINDNESS) && this.vehicle == null && entity instanceof EntityLiving;
                ...
                if (flag2) {
                    entity.g(
                            (double) (-MathHelper.sin(this.yaw * 3.1415927F / 180.0F) * (float) i * 0.425),
                            0.085,
                            (double) (MathHelper.cos(this.yaw * 3.1415927F / 180.0F) * (float) i * 0.425));
                    ...
                    if (entity instanceof EntityPlayer && entity.velocityChanged) {
                        try {
                            ...
                            KnockbackProfile knockback = victim.getKnockback();
