...
public class EntityGhast extends EntityFlying implements IMonster {
    ...
    protected void bq() {
        ...
        if (!this.world.isStatic && !SLSpigotConfig.mobsEnabled) {
            this.die();
        }
    ...
    public boolean canSpawn() {
        // MineHQ - Add mobsEnabled check.
        return this.random.nextInt(20) == 0 && super.canSpawn() && this.world.difficulty != EnumDifficulty.PEACEFUL && SLSpigotConfig.mobsEnabled;
    }
