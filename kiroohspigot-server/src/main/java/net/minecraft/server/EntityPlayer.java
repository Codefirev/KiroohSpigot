...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public void i() {
        ...
        try {
            ...
            if(SLSpigotConfig.updateMapItemsInPlayerInventory) { // Poweruser
    ...
    public void die(DamageSource damagesource) {
        ...
        if (getBukkitEntity().isOnline() && SLSpigotConfig.instantRespawn) {
    ...
    public boolean a(final int i, final String s) {
        ...
        return "tell".equals(s) || "help".equals(s) || "me".equals(s);
    ...
    public void d(Entity entity) {
        this.playerConnection.sendPacket(new PacketPlayOutEntityDestroy(entity.getId())); // MineHQ
    }
