...
public class EntityTypes {
    ...
    private static Map<Integer, Class> e = new HashMap();
    private static Map<Class, Integer> f = new HashMap();
    private static Map<String, Integer> g = new HashMap();
    public static HashMap<Integer, MonsterEggInfo> eggInfo = new LinkedHashMap();

    public static void registerCustomEntity(Class type, String name, int id) {
        d.put(type, name);
        f.put(type, id);
    }
    ...
    private static void a(Class var0, String var1, int var2, int var3, int var4) {
        a(var0, var1, var2);
        eggInfo.put(var2, new MonsterEggInfo(var2, var3, var4));
    }
    ...
    public static int a(Entity var0) {
        ...
        return f.containsKey(var1) ? (Integer)f.get(var1) : 0;
    }
    ...
    public static String b(Entity var0) {
        return d.get(var0.getClass());
    }

    public static String b(int var0) {
        Class var1 = a(var0);
        return var1 != null ? d.get(var1) : null;
    }
