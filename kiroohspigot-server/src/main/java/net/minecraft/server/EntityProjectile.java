...
public abstract class EntityProjectile extends Entity implements IProjectile {
    ...
    public void h() {
        ...
        if(!PaperSpigotConfig.enderpearlCollidesStringFenceGate
                ...
                && movingobjectposition.type == EnumMovingObjectType.BLOCK
                && this instanceof EntityEnderPearl) {
            ...
            if (block == Blocks.FENCE_GATE) {
                if((this.world.getData(x, y, z) & 0x4) != 0) {
                    movingobjectposition = null;
                }
    ...
    private boolean isClear(int x, int y, int z) {
        ...
        return block == null
                ...
                || (block == Blocks.FENCE_GATE && (this.world.getData(x, y, z) & 0x4) != 0x0);
    }
}