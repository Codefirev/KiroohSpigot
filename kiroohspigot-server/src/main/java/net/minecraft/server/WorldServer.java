...
public class WorldServer extends World {
    ...
    public void doTick() {
        if (!SLSpigotConfig.disableWeatherTicking) super.doTick(); // MineHQ
        ...
        if (!SLSpigotConfig.disableSleepCheck && this.everyoneDeeplySleeping()) { // MineHQ
        ...
        if (!SLSpigotConfig.disableBlockTicking) this.g(); // MineHQ
        ...
        // MineHQ start
        if (!SLSpigotConfig.disableVillageTicking) {
            this.villages.tick();
            this.siegeManager.a();
        }
        // MineHQ end
    ...
    public boolean saveOnlyChunks(boolean flag, IProgressUpdate iprogressupdate) {
        if (SLSpigotConfig.disableSaving) return true; // MineHQ
        if (this.chunkProvider.canSave()) {
            if (iprogressupdate != null) {
