...
import network.secondlife.spigot.NamePriorityThreadFactory;
...
public class PathSearchThrottlerThread extends ThreadPoolExecutor {
    ...
    public PathSearchThrottlerThread(int poolSize) {
        super(poolSize, poolSize, 1L, TimeUnit.MINUTES, new LinkedBlockingQueue<Runnable>(), new NamePriorityThreadFactory(Thread.MIN_PRIORITY, "GSpigot_PathFinder"));
        instance = this;
