package network.secondlife.spigot.pathsearch.jobs;

import net.minecraft.server.EntityCreature;
import network.secondlife.spigot.pathsearch.AsyncPathfinder;
import network.secondlife.spigot.pathsearch.PositionPathSearchType;
